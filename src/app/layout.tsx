...
export const metadata: Metadata = {
  ...
  description:
    "Turn one idea into a live ecommerce store. Launch in 60 seconds with everything you need built in.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        className={`${inter.variable} ${dmSans.variable} ${playfair.variable} ${inter.className} antialiased`}
