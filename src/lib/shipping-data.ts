/**
 * Static shipping data — extracted from the shipping page to reduce
 * the main client bundle. This module is only loaded when the shipping
 * route is visited thanks to Next.js route-based code splitting.
 */
...
// Get available countries list from configs
export const AVAILABLE_COUNTRIES = Object.keys(COUNTRY_CONFIGS);
