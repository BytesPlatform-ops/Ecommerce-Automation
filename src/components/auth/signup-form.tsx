...
// Country codes for dropdown with validation rules
const COUNTRY_CODES = [
  { code: "+1", country: "USA/Canada", flag: "🇺🇸", minLen: 10, maxLen: 10, example: "2025551234" },
  { code: "+92", country: "Pakistan", flag: "🇵🇰", minLen: 10, maxLen: 10, example: "3001234567" },
  { code: "+44", country: "UK", flag: "🇬🇧", minLen: 10, maxLen: 10, example: "7911123456" },
  { code: "+91", country: "India", flag: "🇮🇳", minLen: 10, maxLen: 10, example: "9876543210" },
  { code: "+971", country: "UAE", flag: "🇦🇪", minLen: 9, maxLen: 9, example: "501234567" },
  { code: "+966", country: "Saudi Arabia", flag: "🇸🇦", minLen: 9, maxLen: 9, example: "512345678" },
  { code: "+61", country: "Australia", flag: "🇦🇺", minLen: 9, maxLen: 9, example: "412345678" },
  { code: "+49", country: "Germany", flag: "🇩🇪", minLen: 10, maxLen: 11, example: "15123456789" },
  { code: "+33", country: "France", flag: "🇫🇷", minLen: 9, maxLen: 9, example: "612345678" },
  { code: "+86", country: "China", flag: "🇨🇳", minLen: 11, maxLen: 11, example: "13912345678" },
  { code: "+81", country: "Japan", flag: "🇯🇵", minLen: 10, maxLen: 10, example: "9012345678" },
  { code: "+82", country: "South Korea", flag: "🇰🇷", minLen: 9, maxLen: 10, example: "1012345678" },
  { code: "+55", country: "Brazil", flag: "🇧🇷", minLen: 10, maxLen: 11, example: "11987654321" },
  { code: "+52", country: "Mexico", flag: "🇲🇽", minLen: 10, maxLen: 10, example: "5512345678" },
  { code: "+34", country: "Spain", flag: "🇪🇸", minLen: 9, maxLen: 9, example: "612345678" },
  { code: "+39", country: "Italy", flag: "🇮🇹", minLen: 9, maxLen: 10, example: "3123456789" },
  { code: "+31", country: "Netherlands", flag: "🇳🇱", minLen: 9, maxLen: 9, example: "612345678" },
  { code: "+46", country: "Sweden", flag: "🇸🇪", minLen: 9, maxLen: 9, example: "701234567" },
  { code: "+47", country: "Norway", flag: "🇳🇴", minLen: 8, maxLen: 8, example: "41234567" },
  { code: "+45", country: "Denmark", flag: "🇩🇰", minLen: 8, maxLen: 8, example: "20123456" },
];
...
function validatePhoneNumber(phone: string, countryCode: string): { valid: boolean; error?: string } {
  ...
  if (digitsOnly.length < country.minLen) {
    return { valid: false, error: `Phone number must be at least ${country.minLen} digits for ${country.country}` };
  }
  
  if (digitsOnly.length > country.maxLen) {
    return { valid: false, error: `Phone number must be at most ${country.maxLen} digits for ${country.country}` };
  }
...
export function SignupForm() {
  ...
  // Handle form submission - create account directly
      ...
      <div className="space-y-2">
        ...
        <p className="text-[11px] text-muted-foreground">
          {selectedCountry.minLen === selectedCountry.maxLen 
            ? `Enter ${selectedCountry.minLen} digits for ${selectedCountry.country}`
            : `Enter ${selectedCountry.minLen}-${selectedCountry.maxLen} digits for ${selectedCountry.country}`
          }
          {phoneNumber.length > 0 && (
            <span className={phoneNumber.length >= selectedCountry.minLen && phoneNumber.length <= selectedCountry.maxLen ? "text-emerald-600 ml-2" : "text-amber-600 ml-2"}>
