...
const steps = [
  {
    ...
    description:
      "Tell us what you want to sell, your brand vibe, and target audience. Our AI understands natural language.",
    icon: (
  ...
  {
    number: "02",
    title: "Platform builds the full stack",
    description:
      "Database, API, payment integration, product pages, checkout flow — everything generated in seconds.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Custom domain, SSL, CDN — your store is production-ready and accessible to customers worldwide.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
